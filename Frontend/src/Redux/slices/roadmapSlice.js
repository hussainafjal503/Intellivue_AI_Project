...
export const getRoadMapHandler=(goal)=>async(dispatch)=>{
	...
	try{
		const response=await axios.post(`${baseUrl}/api/v1/roadmap/create-goal`,{goal},{
 ...
 export const getResponseByAi=()=>async(dispatch,getState)=>{
	...
	// console.log(_id)
	try{
		const response=await axios.get(`${baseUrl}/api/v1/roadmap/get-roadmap/${_id}`,{
			withCredentials:true
		});
		// console.log(response);
...
export const getAllResponses=()=>async(dispatch)=>{
	try{
		const response=await axios.get(`${baseUrl}/api/v1/roadmap/get-all-response`,{
			withCredentials:true
		});
		// console.log(response);
...
export const singleDetails=(id)=>async(dispatch)=>{
	...
	try{
		const response=await axios.get(`${baseUrl}/api/v1/roadmap/get-detailById/${id}`,{
			withCredentials:true
		});
		// console.log(response)
...
export const deleteRoadmap=(id)=>async(dispatch)=>{
	...
	try{
		const response=await axios.delete(`${baseUrl}/api/v1/roadmap/delete-roadmap/${id}`,{
			withCredentials:true
		});
		// console.log(response);
